...
},{"./accordion/init-accordion":2,"./modules/form-validate/form":5,"./modules/modals/init-modals":11,"./modules/swiper/init-swiper":13,"./modules/tabs/init-tabs":14,"./modules/video/init-video":16,"./utils/ios-vh-fix":19}],4:[function(require,module,exports){
"use strict";
...
exports.initSwiper = exports.initReviewSwiper = void 0;
var _swiper = _interopRequireDefault(require("../../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var sliderCoaches = document.querySelector('.coaches__slider');
var prevButtonCoaches = document.querySelector('.coaches__button-prev');
var nextButtonCoaches = document.querySelector('.coaches__button-next');
var reviewSlider = document.querySelector('.review__slider');
var prevButton = document.querySelector('.review__slider-button-prev');
var nextButton = document.querySelector('.review__slider-button-next');
var initSwiper = function initSwiper() {
  return new _swiper.default(sliderCoaches, {
...
var initReviewSwiper = function initReviewSwiper() {
  return new _swiper.default(reviewSlider, {
    direction: 'horizontal',
    loop: false,
    slidesPerView: 1,
    navigation: {
...
var Tabs = /*#__PURE__*/function () {
  ...
  _createClass(Tabs, [{
    ...
    value: function openTab(control) {
      ...
      var currentHeight = contentElement ? contentElement.offsetHeight : '100%';
      var newHeight = tabElements[currentIndex] ? tabElements[currentIndex].offsetHeight : currentHeight;
...
var image = document.querySelector('#video-poster');
